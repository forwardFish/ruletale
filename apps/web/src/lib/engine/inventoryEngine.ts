...
import type { MvpPsychStats, MvpVisibleStats, MvpWorldState } from "@/lib/types/game";
import type { InventoryEntry, InventoryScope, InventoryUseResult } from "@/lib/types/inventory";
