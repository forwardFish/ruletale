import { ENDINGS } from "@/lib/data/endings";
import { evaluateBlackZoneProgress } from "@/lib/data/lobby";
import { MONSTERS } from "@/lib/data/monsters";
import type { MvpCombatAction, MvpDungeonRuntime, MvpParsedAction, MvpPlayerState, MvpProgressState } from "@/lib/types/game";
import type { InventoryEntry } from "@/lib/types/inventory";
import type { NodeOutcome } from "@/lib/types/node";
...
function failureEndingId(dungeonId: string) {
  return dungeonId === "apartment_night_return" ? "apartment_wrong_clear" : "wrong_clear";
}
